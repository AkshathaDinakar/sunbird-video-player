...
export class QuestionCursorImplementationService implements QuestionCursor {
    listUrl: string;
    currentTime: number;
    currentQuestion: any; // Define this url to call list api in server
    questionsArray = {
        "questions": [
            {
            "copyright": "tn",
        ...
        },
        {
            ...
            "mimeType": "application/vnd.sunbird.question",
            "media": [],
            "body": "<div class='question-body'><div class='mcq-title'><p>Which is the best IPL team?</p></div><div data-choice-interaction='response1' class='mcq-grid-split'></div></div>",
            "editorState": {
                "options": [{
                    "answer": true,
                    "value": {
            ...
            "showSolutions": "No",
            "allowAnonymousAccess": "Yes",
            "identifier": "do_2132579020493209601128",
            "lastStatusChangedOn": "2021-04-14T11:24:21.292+0000",
            "audience": ["Student"],
            "visibility": "Parent",
            "showTimer": "No",
        ...
        },
        {
            ...
            "mimeType": "application/vnd.sunbird.question",
            "media": [],
            "body": "<div class='question-body'><div class='mcq-title'><p>Who is the captian of RCB?</p></div><div data-choice-interaction='response1' class='mcq-grid-split'></div></div>",
            "editorState": {
                "options": [{
                    "answer": false,
                    "value": {
                ...
                "question": "<p>Who is the captian of RCB?</p>"
            },
            "templateId": "mcq-grid-split",
            "createdOn": "2021-04-14T10:30:46.255+0000",
            "interactions": {
            ...
            "showSolutions": "No",
            "allowAnonymousAccess": "Yes",
            "identifier": "do_2132579020493209601139",
            "lastStatusChangedOn": "2021-04-14T11:24:21.292+0000",
            "audience": ["Student"],
            "visibility": "Parent",
            "showTimer": "No",
